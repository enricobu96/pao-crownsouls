...
\subsection{Abstract}
Si vuole realizzare un programma per la gestione di un inventario giocatore per il gioco \textit{Action RPG} \textfb{"Dark Souls"}. Il giocatore possiede svariati elementi di diversi tipi; questi tipi possono essere:
\begin{itemize}
